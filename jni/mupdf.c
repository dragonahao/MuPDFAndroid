...
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_openFile(JNIEnv * env, jobject thiz, jstring jfilename)
{
	const char *filename;
	char *password = "";
	int accelerate = 1;
...
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_gotoPageInternal(JNIEnv *env, jobject thiz, int page)
{
	float zoom;
	fz_matrix ctm;
	fz_bbox bbox;
...
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_getPageWidth(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT float JNICALL
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_getPageHeight(JNIEnv *env, jobject thiz)
{
...
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_drawPage(JNIEnv *env, jobject thiz, jobject bitmap,
...
JNIEXPORT void JNICALL
Java_eu_areamobile_apis_mupdf_jni_MuPDFCore_destroying(JNIEnv * env, jobject thiz)
{
	fz_free_display_list(currentPageList);
	currentPageList = NULL;
	pdf_free_xref(xref);
